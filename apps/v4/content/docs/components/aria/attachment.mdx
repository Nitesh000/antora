...
```bash
npx shadcn@latest add https://antora.thecodintant.in/r/styles/aria-nova/attachment.json
```
...
```bash
npx shadcn@latest add https://antora.thecodintant.in/r/styles/aria-nova/button.json
```
