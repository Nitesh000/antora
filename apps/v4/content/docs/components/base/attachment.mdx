...
```bash
npx shadcn@latest add https://antora.thecodintant.in/r/styles/base-nova/attachment.json
```
...
```bash
npx shadcn@latest add https://antora.thecodintant.in/r/styles/base-nova/button.json
```
