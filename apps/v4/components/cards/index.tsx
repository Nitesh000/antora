...
const gridColumn = {
  ...
  show: { opacity: 1, y: 0, scale: 1, transition: fluidLayout },
}
...
export function CardsDemo() {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="show"
      className="md:grids-col-2 grid **:data-[slot=card]:shadow-none md:gap-4 lg:grid-cols-10 xl:grid-cols-11"
    >
      <motion.div variants={gridColumn} className="grid gap-4 lg:col-span-4 xl:col-span-6">
        <CardsStats />
      ...
      <motion.div variants={gridColumn} className="flex flex-col gap-4 lg:col-span-6 xl:col-span-5">
